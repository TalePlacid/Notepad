...
FindNextCommand_Fixed::FindNextCommand_Fixed(CWnd* parent, CFindReplaceDialog* findReplaceDialog)
	:FindReplaceCommand(parent, findReplaceDialog) {

}

FindNextCommand_Fixed::~FindNextCommand_Fixed() {

}

void FindNextCommand_Fixed::Execute() {
