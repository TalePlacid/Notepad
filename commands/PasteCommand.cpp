...
void PasteCommand::Execute() {
	...
	if (isPasted)
	{
		...
		if (isSelected)
		{
			...
			editor.EraseRange(this->frontOffset, this->rearOffset, this->erased, this->columnIndex);
		}
...
void PasteCommand::Undo() {
	...
	editor.EraseRange(this->frontOffset, rearOffset, this->contents, this->columnIndex);
